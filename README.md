...
You can open the Jupyter Notebooks in Colab (on this [site](https://kirenz.github.io/lab-langchain-basics/slide.html)) or in GitHub Codespaces (see instructions below).

## Create Codespace


[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/kirenz/lab-langchain-basics?quickstart=1)
